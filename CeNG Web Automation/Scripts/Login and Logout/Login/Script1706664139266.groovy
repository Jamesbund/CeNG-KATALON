...
WebUI.click(findTestObject('Object Repository/Page_Card eSystemNextGen/button_Login'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Core/h4_Dashboard'))
