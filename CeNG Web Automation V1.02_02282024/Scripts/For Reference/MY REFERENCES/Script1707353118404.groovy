...
WebUI.click(findTestObject('Object Repository/For Reference/Page_DEMOQA/span_Text Box'))
...
WebUI.setText(findTestObject('Object Repository/Random Generation of Names/Page_DEMOQA/input_Full Name_userName'), nameParts[
    0 // Set first name in inputField1
    ])

WebUI.setText(findTestObject('Object Repository/Random Generation of Names/Page_DEMOQA/input_Email_userEmail'), nameParts[
    1 // Set last name in inputField2
    ])
