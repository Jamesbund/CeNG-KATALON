...
WebUI.callTestCase(findTestCase('Client Module/Client Creation/Address'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Client Module/Client Creation/ID Presented'), [:], FailureHandling.STOP_ON_FAILURE)
